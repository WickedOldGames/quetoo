...
static void Cg_Init(void) {
  ...
  cg_draw_captures = cgi.AddCvar("cg_draw_captures", "1", CVAR_ARCHIVE, "Draw the number of captures");
  ...
  cg_draw_powerups = cgi.AddCvar("cg_draw_powerups", "1", CVAR_ARCHIVE, "Draw currently active powerups, such as Quad Damage and Adrenaline.");

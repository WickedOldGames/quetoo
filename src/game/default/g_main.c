...
cvar_t *g_balance_quake_nailgun_spread_x;
cvar_t *g_balance_quake_nailgun_spread_y;
...
cvar_t *g_balance_quake_supernailgun_spread_x;
cvar_t *g_balance_quake_supernailgun_spread_y;
...
cvar_t *g_balance_quake_lightning_damage;
cvar_t *g_balance_quake_lightning_knockback;
cvar_t *g_balance_quake_lightning_length;
cvar_t *g_balance_quake_lightning_refire;
cvar_t *g_balance_quake_shadows_respawn_time;
cvar_t *g_balance_quake_shadows_time;
cvar_t *g_balance_quake_pentagram_respawn_time;
cvar_t *g_balance_quake_pentagram_time;
...
void G_Init(void) {
  ...
  g_balance_armor_shard_respawn = gi.AddCvar("g_balance_armor_shard_respawn", "15", CVAR_ARCHIVE, NULL);
  g_balance_armor_jacket_respawn = gi.AddCvar("g_balance_armor_jacket_respawn", "25", CVAR_ARCHIVE, NULL);
  g_balance_armor_combat_respawn = gi.AddCvar("g_balance_armor_combat_respawn", "25", CVAR_ARCHIVE, NULL);
  g_balance_armor_body_respawn = gi.AddCvar("g_balance_armor_body_respawn", "30", CVAR_ARCHIVE, NULL);
  g_balance_bfg_damage = gi.AddCvar("g_balance_bfg_damage", "180", CVAR_ARCHIVE, NULL);
  g_balance_bfg_knockback = gi.AddCvar("g_balance_bfg_knockback", "140", CVAR_ARCHIVE, NULL);
  g_balance_bfg_prefire = gi.AddCvar("g_balance_bfg_prefire", "1", CVAR_ARCHIVE, "The prefire warmup delay for the BFG10K in seconds.");
  g_balance_bfg_radius = gi.AddCvar("g_balance_bfg_radius", "512", CVAR_ARCHIVE, NULL);
  g_balance_bfg_refire = gi.AddCvar("g_balance_bfg_refire", "2", CVAR_ARCHIVE, NULL);
  g_balance_bfg_speed = gi.AddCvar("g_balance_bfg_speed", "720", CVAR_ARCHIVE, NULL);
  g_balance_blaster_damage = gi.AddCvar("g_balance_blaster_damage", "15", CVAR_ARCHIVE, NULL);
  g_balance_blaster_knockback = gi.AddCvar("g_balance_blaster_knockback", "2", CVAR_ARCHIVE, NULL);
  g_balance_blaster_refire = gi.AddCvar("g_balance_blaster_refire", "0.45", CVAR_ARCHIVE, NULL);
  g_balance_blaster_speed = gi.AddCvar("g_balance_blaster_speed", "2000", CVAR_ARCHIVE, NULL);
  g_balance_handgrenade_refire = gi.AddCvar("g_balance_handgrenade_refire", "2", CVAR_ARCHIVE, NULL);
  g_balance_health_small_respawn = gi.AddCvar("g_balance_health_small_respawn", "15", CVAR_ARCHIVE, NULL);
  g_balance_health_medium_respawn = gi.AddCvar("g_balance_health_medium_respawn", "20", CVAR_ARCHIVE, NULL);
  g_balance_health_large_respawn = gi.AddCvar("g_balance_health_large_respawn", "30", CVAR_ARCHIVE, NULL);
  g_balance_health_mega_respawn = gi.AddCvar("g_balance_health_mega_respawn", "60", CVAR_ARCHIVE, NULL);
  g_balance_hyperblaster_climb_damage = gi.AddCvar("g_balance_hyperblaster_climb_damage", "3", CVAR_ARCHIVE, NULL);
  g_balance_hyperblaster_climb_knockback = gi.AddCvar("g_balance_hyperblaster_climb_knockback", "68", CVAR_ARCHIVE, NULL);
  g_balance_hyperblaster_damage = gi.AddCvar("g_balance_hyperblaster_damage", "16", CVAR_ARCHIVE, NULL);
  g_balance_hyperblaster_knockback = gi.AddCvar("g_balance_hyperblaster_knockback", "4", CVAR_ARCHIVE, NULL);
  g_balance_hyperblaster_refire = gi.AddCvar("g_balance_hyperblaster_refire", "0.1", CVAR_ARCHIVE, NULL);
  g_balance_hyperblaster_speed = gi.AddCvar("g_balance_hyperblaster_speed", "1800", CVAR_ARCHIVE, NULL);
  g_balance_lightning_damage = gi.AddCvar("g_balance_lightning_damage", "12", CVAR_ARCHIVE, NULL);
  g_balance_lightning_knockback = gi.AddCvar("g_balance_lightning_knockback", "6", CVAR_ARCHIVE, NULL);
  g_balance_lightning_length = gi.AddCvar("g_balance_lightning_length", "600", CVAR_ARCHIVE, NULL);
  g_balance_lightning_refire = gi.AddCvar("g_balance_lightning_refire", "0.1", CVAR_ARCHIVE, NULL);
  g_balance_machinegun_damage = gi.AddCvar("g_balance_machinegun_damage", "8", CVAR_ARCHIVE, NULL);
  g_balance_machinegun_knockback = gi.AddCvar("g_balance_machinegun_knockback", "2", CVAR_ARCHIVE, NULL);
  g_balance_machinegun_refire = gi.AddCvar("g_balance_machinegun_refire", "0.1", CVAR_ARCHIVE, NULL);
  g_balance_machinegun_spread_x = gi.AddCvar("g_balance_machinegun_spread_x", "20", CVAR_ARCHIVE, NULL);
  g_balance_machinegun_spread_y = gi.AddCvar("g_balance_machinegun_spread_y", "200", CVAR_ARCHIVE, NULL);
  g_balance_grenadelauncher_damage = gi.AddCvar("g_balance_grenadelauncher_damage", "120", CVAR_ARCHIVE, NULL);
  g_balance_grenadelauncher_knockback = gi.AddCvar("g_balance_grenadelauncher_knockback", "120", CVAR_ARCHIVE, NULL);
  g_balance_grenadelauncher_radius = gi.AddCvar("g_balance_grenadelauncher_radius", "185", CVAR_ARCHIVE, NULL);
  g_balance_grenadelauncher_refire = gi.AddCvar("g_balance_grenadelauncher_refire", "1", CVAR_ARCHIVE, NULL);
  g_balance_grenadelauncher_speed = gi.AddCvar("g_balance_grenadelauncher_speed", "800", CVAR_ARCHIVE, NULL);
  g_balance_grenadelauncher_timer = gi.AddCvar("g_balance_grenadelauncher_timer", "2.5", CVAR_ARCHIVE, NULL);
  g_balance_quad_damage_respawn_time = gi.AddCvar("g_balance_quad_damage_respawn_time", "60", CVAR_ARCHIVE, NULL);
  g_balance_quad_damage_time = gi.AddCvar("g_balance_quad_damage_time", "30", CVAR_ARCHIVE, NULL);
  g_balance_quake_shotgun_damage = gi.AddCvar("g_balance_quake_shotgun_damage", "4", CVAR_ARCHIVE, NULL);
  g_balance_quake_shotgun_knockback = gi.AddCvar("g_balance_quake_shotgun_knockback", "2", CVAR_ARCHIVE, NULL);
  g_balance_quake_shotgun_pellets = gi.AddCvar("g_balance_quake_shotgun_pellets", "6", CVAR_ARCHIVE, NULL);
  g_balance_quake_shotgun_refire = gi.AddCvar("g_balance_quake_shotgun_refire", "0.5", CVAR_ARCHIVE, NULL);
  g_balance_quake_shotgun_spread_x = gi.AddCvar("g_balance_quake_shotgun_spread_x", "1000", CVAR_ARCHIVE, NULL);
  g_balance_quake_shotgun_spread_y = gi.AddCvar("g_balance_quake_shotgun_spread_y", "500", CVAR_ARCHIVE, NULL);
  g_balance_quake_supershotgun_damage = gi.AddCvar("g_balance_quake_supershotgun_damage", "4", CVAR_ARCHIVE, NULL);
  g_balance_quake_supershotgun_knockback = gi.AddCvar("g_balance_quake_supershotgun_knockback", "2", CVAR_ARCHIVE, NULL);
  g_balance_quake_supershotgun_pellets = gi.AddCvar("g_balance_quake_supershotgun_pellets", "14", CVAR_ARCHIVE, NULL);
  g_balance_quake_supershotgun_refire = gi.AddCvar("g_balance_quake_supershotgun_refire", "0.7", CVAR_ARCHIVE, NULL);
  g_balance_quake_supershotgun_spread_x = gi.AddCvar("g_balance_quake_supershotgun_spread_x", "1600", CVAR_ARCHIVE, NULL);
  g_balance_quake_supershotgun_spread_y = gi.AddCvar("g_balance_quake_supershotgun_spread_y", "500", CVAR_ARCHIVE, NULL);
  g_balance_quake_nailgun_damage = gi.AddCvar("g_balance_quake_nailgun_damage", "9", CVAR_ARCHIVE, NULL);
  g_balance_quake_nailgun_knockback = gi.AddCvar("g_balance_quake_nailgun_knockback", "4", CVAR_ARCHIVE, NULL);
  g_balance_quake_nailgun_refire = gi.AddCvar("g_balance_quake_nailgun_refire", "0.1", CVAR_ARCHIVE, NULL);
  g_balance_quake_nailgun_speed = gi.AddCvar("g_balance_quake_nailgun_speed", "1000", CVAR_ARCHIVE, NULL);
  g_balance_quake_nailgun_spread_x = gi.AddCvar("g_balance_quake_nailgun_spread_x", "100", CVAR_ARCHIVE, NULL);
  g_balance_quake_nailgun_spread_y = gi.AddCvar("g_balance_quake_nailgun_spread_y", "100", CVAR_ARCHIVE, NULL);
  g_balance_quake_supernailgun_damage = gi.AddCvar("g_balance_quake_supernailgun_damage", "9", CVAR_ARCHIVE, NULL);
  g_balance_quake_supernailgun_knockback = gi.AddCvar("g_balance_quake_supernailgun_knockback", "4", CVAR_ARCHIVE, NULL);
  g_balance_quake_supernailgun_refire = gi.AddCvar("g_balance_quake_supernailgun_refire", "0.1", CVAR_ARCHIVE, NULL);
  g_balance_quake_supernailgun_speed = gi.AddCvar("g_balance_quake_supernailgun_speed", "1000", CVAR_ARCHIVE, NULL);
  g_balance_quake_supernailgun_spread_x = gi.AddCvar("g_balance_quake_supernailgun_spread_x", "100", CVAR_ARCHIVE, NULL);
  g_balance_quake_supernailgun_spread_y = gi.AddCvar("g_balance_quake_supernailgun_spread_y", "100", CVAR_ARCHIVE, NULL);
  g_balance_quake_grenadelauncher_damage = gi.AddCvar("g_balance_quake_grenadelauncher_damage", "120", CVAR_ARCHIVE, NULL);
  g_balance_quake_grenadelauncher_knockback = gi.AddCvar("g_balance_quake_grenadelauncher_knockback", "120", CVAR_ARCHIVE, NULL);
  g_balance_quake_grenadelauncher_radius = gi.AddCvar("g_balance_quake_grenadelauncher_radius", "185", CVAR_ARCHIVE, NULL);
  g_balance_quake_grenadelauncher_refire = gi.AddCvar("g_balance_quake_grenadelauncher_refire", "0.8", CVAR_ARCHIVE, NULL);
  g_balance_quake_grenadelauncher_speed = gi.AddCvar("g_balance_quake_grenadelauncher_speed", "700", CVAR_ARCHIVE, NULL);
  g_balance_quake_grenadelauncher_timer = gi.AddCvar("g_balance_quake_grenadelauncher_timer", "2.5", CVAR_ARCHIVE, NULL);
  g_balance_quake_rocketlauncher_damage = gi.AddCvar("g_balance_quake_rocketlauncher_damage", "100", CVAR_ARCHIVE, NULL);
  g_balance_quake_rocketlauncher_knockback = gi.AddCvar("g_balance_quake_rocketlauncher_knockback", "75", CVAR_ARCHIVE, NULL);
  g_balance_quake_rocketlauncher_radius = gi.AddCvar("g_balance_quake_rocketlauncher_radius", "150", CVAR_ARCHIVE, NULL);
  g_balance_quake_rocketlauncher_refire = gi.AddCvar("g_balance_quake_rocketlauncher_refire", "0.9", CVAR_ARCHIVE, NULL);
  g_balance_quake_rocketlauncher_speed = gi.AddCvar("g_balance_quake_rocketlauncher_speed", "800", CVAR_ARCHIVE, NULL);
  g_balance_quake_lightning_damage = gi.AddCvar("g_balance_quake_lightning_damage", "14", CVAR_ARCHIVE, NULL);
  g_balance_quake_lightning_knockback = gi.AddCvar("g_balance_quake_lightning_knockback", "8", CVAR_ARCHIVE, NULL);
  g_balance_quake_lightning_length = gi.AddCvar("g_balance_quake_lightning_length", "768", CVAR_ARCHIVE, NULL);
  g_balance_quake_lightning_refire = gi.AddCvar("g_balance_quake_lightning_refire", "0.05", CVAR_ARCHIVE, NULL);
  g_balance_quake_shadows_respawn_time = gi.AddCvar("g_balance_quake_shadows_respawn_time", "60", CVAR_ARCHIVE, NULL);
  g_balance_quake_shadows_time = gi.AddCvar("g_balance_quake_shadows_time", "30", CVAR_ARCHIVE, NULL);
  g_balance_quake_pentagram_respawn_time = gi.AddCvar("g_balance_quake_pentagram_respawn_time", "60", CVAR_ARCHIVE, NULL);
  g_balance_quake_pentagram_time = gi.AddCvar("g_balance_quake_pentagram_time", "30", CVAR_ARCHIVE, NULL);
  g_balance_railgun_damage = gi.AddCvar("g_balance_railgun_damage", "100", CVAR_ARCHIVE, NULL);
  g_balance_railgun_knockback = gi.AddCvar("g_balance_railgun_knockback", "80", CVAR_ARCHIVE, NULL);
  g_balance_railgun_refire = gi.AddCvar("g_balance_railgun_refire", "1.4", CVAR_ARCHIVE, NULL);
  g_balance_rocketlauncher_damage = gi.AddCvar("g_balance_rocketlauncher_damage", "100", CVAR_ARCHIVE, NULL);
  g_balance_rocketlauncher_knockback = gi.AddCvar("g_balance_rocketlauncher_knockback", "75", CVAR_ARCHIVE, NULL);
  g_balance_rocketlauncher_radius = gi.AddCvar("g_balance_rocketlauncher_radius", "150", CVAR_ARCHIVE, NULL);
  g_balance_rocketlauncher_refire = gi.AddCvar("g_balance_rocketlauncher_refire", "1", CVAR_ARCHIVE, NULL);
  g_balance_rocketlauncher_speed = gi.AddCvar("g_balance_rocketlauncher_speed", "1000", CVAR_ARCHIVE, NULL);
  g_balance_shotgun_damage = gi.AddCvar("g_balance_shotgun_damage", "4", CVAR_ARCHIVE, NULL);
  g_balance_shotgun_knockback = gi.AddCvar("g_balance_shotgun_knockback", "2", CVAR_ARCHIVE, NULL);
  g_balance_shotgun_pellets = gi.AddCvar("g_balance_shotgun_pellets", "12", CVAR_ARCHIVE, NULL);
  g_balance_shotgun_refire = gi.AddCvar("g_balance_shotgun_refire", "0.6", CVAR_ARCHIVE, NULL);
  g_balance_shotgun_spread_x = gi.AddCvar("g_balance_shotgun_spread_x", "700", CVAR_ARCHIVE, NULL);
  g_balance_shotgun_spread_y = gi.AddCvar("g_balance_shotgun_spread_y", "300", CVAR_ARCHIVE, NULL);
  g_balance_supershotgun_damage = gi.AddCvar("g_balance_supershotgun_damage", "4", CVAR_ARCHIVE, NULL);
  g_balance_supershotgun_knockback = gi.AddCvar("g_balance_supershotgun_knockback", "2", CVAR_ARCHIVE, NULL);
  g_balance_supershotgun_pellets = gi.AddCvar("g_balance_supershotgun_pellets", "24", CVAR_ARCHIVE, NULL);
  g_balance_supershotgun_refire = gi.AddCvar("g_balance_supershotgun_refire", "0.8", CVAR_ARCHIVE, NULL);
  g_balance_supershotgun_spread_x = gi.AddCvar("g_balance_supershotgun_spread_x", "1600", CVAR_ARCHIVE, NULL);
  g_balance_supershotgun_spread_y = gi.AddCvar("g_balance_supershotgun_spread_y", "500", CVAR_ARCHIVE, NULL);

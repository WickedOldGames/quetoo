...
void G_Init(void) {
  ...
  g_balance_quake_shotgun_spread_x = gi.AddCvar("g_balance_quake_shotgun_spread_x", "1000", 0, NULL);
  g_balance_quake_shotgun_spread_y = gi.AddCvar("g_balance_quake_shotgun_spread_y", "500", 0, NULL);
  ...
  g_balance_quake_supershotgun_spread_x = gi.AddCvar("g_balance_quake_supershotgun_spread_x", "1600", 0, NULL);
  g_balance_quake_supershotgun_spread_y = gi.AddCvar("g_balance_quake_supershotgun_spread_y", "500", 0, NULL);
  ...
  g_balance_quake_nailgun_spread_x = gi.AddCvar("g_balance_quake_nailgun_spread_x", "100", 0, NULL);
  g_balance_quake_nailgun_spread_y = gi.AddCvar("g_balance_quake_nailgun_spread_y", "100", 0, NULL);
  ...
  g_balance_quake_supernailgun_spread_x = gi.AddCvar("g_balance_quake_supernailgun_spread_x", "100", 0, NULL);
  g_balance_quake_supernailgun_spread_y = gi.AddCvar("g_balance_quake_supernailgun_spread_y", "100", 0, NULL);
  ...
  g_balance_quake_lightning_refire = gi.AddCvar("g_balance_quake_lightning_refire", "0.05", 0, NULL);
  g_balance_quake_shadows_respawn_time = gi.AddCvar("g_balance_quake_shadows_respawn_time", "60", 0, NULL);
  g_balance_quake_shadows_time = gi.AddCvar("g_balance_quake_shadows_time", "30", 0, NULL);
  g_balance_quake_pentagram_respawn_time = gi.AddCvar("g_balance_quake_pentagram_respawn_time", "60", 0, NULL);
  g_balance_quake_pentagram_time = gi.AddCvar("g_balance_quake_pentagram_time", "30", 0, NULL);

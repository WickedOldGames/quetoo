...
static void G_InitMedia(void) {
  ...
  g_media.sounds.techs[TECH_HASTE] = gi.SoundIndex("techs/haste");
  g_media.sounds.techs[TECH_REGEN] = gi.SoundIndex("techs/regen");
  g_media.sounds.techs[TECH_RESIST] = gi.SoundIndex("techs/resist");
  g_media.sounds.techs[TECH_STRENGTH] = gi.SoundIndex("techs/strength");
  g_media.sounds.techs[TECH_VAMPIRE] = gi.SoundIndex("techs/vampire");

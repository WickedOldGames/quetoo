...
static g_item_t g_items[] = {
...

  {
    ...
    .Drop = G_DropTech,
    .Think = NULL,
    .pickup_sound = "powerups/pickup/pickup.wav",
    .model = "models/powerups/haste/tris.obj",
    .effects = EF_BOB | EF_ROTATE ,
    .icon = "pics/t_haste",
    .name = "Haste",
    .quantity = 0,
...

  {
    ...
    .Think = NULL,
    .pickup_sound = "powerups/pickup/pickup.wav",
    .model = "models/powerups/regen/tris.obj",
    .effects = EF_BOB | EF_ROTATE ,
    .icon = "pics/t_regen",
    .name = "Regeneration",
    .quantity = 0,
...

  {
    ...
    .Think = NULL,
    .pickup_sound = "powerups/pickup/pickup.wav",
    .model = "models/powerups/resist/tris.obj",
    .effects = EF_BOB | EF_ROTATE ,
    .icon = "pics/t_resist",
    .name = "Resist",
    .quantity = 0,
...

  {
    ...
    .Think = NULL,
    .pickup_sound = "powerups/pickup/pickup.wav",
    .model = "models/powerups/strength/tris.obj",
    .effects = EF_BOB | EF_ROTATE ,
...

  {
    ...
    .Think = NULL,
    .pickup_sound = "powerups/pickup/pickup.wav",
    .model = "models/powerups/vampire/tris.obj",
    .effects = EF_BOB | EF_ROTATE ,
    .icon = "pics/t_vampire",
    .name = "Vampire",
    .quantity = 0,
